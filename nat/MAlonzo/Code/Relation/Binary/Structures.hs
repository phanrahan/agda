...
data T_IsDecStrictPartialOrder_312
  = C_IsDecStrictPartialOrder'46'constructor_17749 T_IsStrictPartialOrder_266
                                                   (AgdaAny ->
                                                    AgdaAny ->
                                                    MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20)
                                                   (AgdaAny ->
...
d_isStrictPartialOrder_322 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17749 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8799'__324 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17749 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Structures.IsDecStrictPartialOrder._<?_
d__'60''63'__326 ::
  T_IsDecStrictPartialOrder_312 ->
...
d__'60''63'__326 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17749 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsTotalOrder_380
  = C_IsTotalOrder'46'constructor_19633 T_IsPartialOrder_162
                                        (AgdaAny ->
                                         AgdaAny -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30)
...
d_isPartialOrder_388 v0
  = case coe v0 of
      C_IsTotalOrder'46'constructor_19633 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_total_390 v0
  = case coe v0 of
      C_IsTotalOrder'46'constructor_19633 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsDecTotalOrder_430
  = C_IsDecTotalOrder'46'constructor_21603 T_IsTotalOrder_380
                                           (AgdaAny ->
                                            AgdaAny ->
                                            MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20)
                                           (AgdaAny ->
...
d_isTotalOrder_440 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21603 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8799'__442 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21603 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Structures.IsDecTotalOrder._≤?_
d__'8804''63'__444 ::
  T_IsDecTotalOrder_430 ->
...
d__'8804''63'__444 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21603 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsStrictTotalOrder_498
  = C_IsStrictTotalOrder'46'constructor_23817 T_IsEquivalence_26
                                              (AgdaAny ->
                                               AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny ->
                                               AgdaAny ->
...
d_isEquivalence_508 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23817 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_trans_510 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23817 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_compare_512 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23817 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isDecStrictPartialOrder_538 v0
  = coe
      C_IsDecStrictPartialOrder'46'constructor_17749
...
data T_IsApartnessRelation_556
  = C_IsApartnessRelation'46'constructor_29133 (AgdaAny ->
                                                AgdaAny -> AgdaAny -> AgdaAny)
                                               (AgdaAny ->
                                                AgdaAny ->
                                                AgdaAny ->
...
d_sym_568 v0
  = case coe v0 of
      C_IsApartnessRelation'46'constructor_29133 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_cotrans_570 v0
  = case coe v0 of
      C_IsApartnessRelation'46'constructor_29133 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
